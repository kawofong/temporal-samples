"""
Demonstrate behavior of serial local activities that fail.
...
TASK_QUEUE = "failed-serial-task-queue"
...
class HelloWorkflow:
    ...
    async def run(self) -> None:
        ...
        Workflow runner.
        """
        # Execute local activity that succeeds, fails, then succeeds
