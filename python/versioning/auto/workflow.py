...
1. In a new terminal, use `poe` to run the Worker:
    ...
    ```bash
    uv run poe versioning_auto_worker
    ```
...
1. In a new terminal, use `poe` to run the V1 Workflow:
    ...
    ```bash
    uv run poe versioning_auto_workflow
    ```
...
1. In a new terminal, use `poe` to run the Worker:
    ...
    ```bash
    uv run poe versioning_auto_worker_v2
    ```

1. Use the `temporal` CLI to update current version to V2:
